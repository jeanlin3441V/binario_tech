...
RESP=$(curl -s -X POST http://localhost:3000/api/v1/manutencoes \
  ...
  -d '{"veiculoPlaca":"SCA-2026","tipoManutencao":"PREVENTIVA","custoTotal":1500.00,"pecasSubstituidas":[{"nomePeca":"Filtro de Óleo","quantidade":2,"custoUnitario":150.00},{"nomePeca":"Óleo do Motor 15W40","quantidade":1,"custoUnitario":1200.00}]}')
